...
public class Search {
     ...
     *
     * @param facelets     is the cube definition string, see {@link Facelet} for the format.
     ...
     *                     an error code.
     * @param useSeparator determines if a " . " separates the phase1 and phase2 parts of the solver string like in F' R B R L2 F .
    ...
    public String solution(String facelets, int maxDepth, long timeOut, boolean useSeparator) {
        ...
        System.out.println("结束初始化：" + System.currentTimeMillis());
        po[0] = 0;
        ax[0] = 0;
        flip[0] = c.flip;
        twist[0] = c.twist;
